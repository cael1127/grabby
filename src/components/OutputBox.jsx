...
export default function OutputBox({ type, output, aiScore, aiBreakdown, input }) {
      ...
      <div className="mb-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="p-4 rounded-lg bg-gray-900 border border-gray-700 min-h-[120px] whitespace-pre-wrap text-white shadow-inner">{input}</div>
          </div>
          <div>
